...
const SignIn = () => {
    ...
    const handleOnSubmit = e => {
        e.preventDefault()
        const form = e.target;
        const captchaValue = form.captchaValue.value
    ...
    return (
        <div class="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 lg:max-w-4xl">
            <div class="hidden bg-cover  lg:w-1/2 items-center lg:flex">
            ...
            <div class="w-full px-6 py-8 md:px-8 lg:w-1/2">
                ...
                <p class="mt-3 text-xl text-center font-bold text-gray-600 dark:text-gray-200">
                    SignIn!
                </p>
                ...
                <form onSubmit={handleOnSubmit}>
                    ...
                    <div class="mt-4">
                        <div class="flex justify-between">
                            <label class="block mb-2 text-sm font-medium text-gray-600 dark:text-gray-200" > <LoadCanvasTemplate /></label>
                        </div>

                        <input name='captchaValue' placeholder="Enter Captcha Value" class="block w-full px-4 py-2 text-gray-700 bg-white border rounded-lg dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring focus:ring-blue-300" type="password" />
                    </div>

                    <div class="mt-6">
                        <input type="submit" value='SignIn' class="w-full bg-primary px-6 py-3 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform  rounded-lg hover:bg-gray-700 focus:outline-none focus:ring focus:ring-gray-300 focus:ring-opacity-50" />
                    </div>
                ...
                <div class="flex items-center justify-center mt-4">
                    ...
                    <button href="#" class="text-xs uppercase dark:text-gray-400 hover:underline text-primary text-center">New here? Create a New Account</button>
